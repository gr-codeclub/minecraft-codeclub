 ...
 *
 */
package net.mcreator.rougayatou;
...
@Mod("rougayatou")
public class RougayatouMod {
	public static final Logger LOGGER = LogManager.getLogger(RougayatouMod.class);
	public static final String MODID = "rougayatou";

	public RougayatouMod() {
