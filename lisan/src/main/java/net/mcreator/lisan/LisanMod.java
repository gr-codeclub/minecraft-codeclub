...
@Mod("lisan")
public class LisanMod {
	public static final Logger LOGGER = LogManager.getLogger(LisanMod.class);
	public static final String MODID = "lisan";
