...
public class ChubertosModItems {
	...
	public static final RegistryObject<Item> BLEXTER_SPAWN_EGG = REGISTRY.register("blexter_spawn_egg", () -> new ForgeSpawnEggItem(ChubertosModEntities.BLEXTER, -1, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
