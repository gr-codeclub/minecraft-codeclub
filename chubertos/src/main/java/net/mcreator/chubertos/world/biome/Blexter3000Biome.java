...
package net.mcreator.chubertos.world.biome;
...
public class Blexter3000Biome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-6750208).waterColor(-16777216).waterFogColor(-16777165).skyColor(-6750208).foliageColorOverride(-16777216).grassColorOverride(-16777165).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("chubertos:tree_blexter_3000",
						FeatureUtils.register("chubertos:tree_blexter_3000", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("chubertos:grass_blexter_3000", VegetationFeatures.PATCH_GRASS, List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("chubertos:flower_blexter_3000", VegetationFeatures.FLOWER_DEFAULT,
		...
		mobSpawnInfo.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ChubertosModEntities.BLEXTER.get(), 21, 4, 4));
