 ...
 *
 */
package net.mcreator.chubertos;
...
@Mod("chubertos")
public class ChubertosMod {
	public static final Logger LOGGER = LogManager.getLogger(ChubertosMod.class);
	public static final String MODID = "chubertos";
