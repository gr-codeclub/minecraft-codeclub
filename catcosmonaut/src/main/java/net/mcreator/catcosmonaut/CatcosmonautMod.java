 ...
 *
 */
package net.mcreator.catcosmonaut;
...
@Mod("catcosmonaut")
public class CatcosmonautMod {
	public static final Logger LOGGER = LogManager.getLogger(CatcosmonautMod.class);
	public static final String MODID = "catcosmonaut";

	public CatcosmonautMod() {
