...
@Mod("omar")
public class OmarMod {
	public static final Logger LOGGER = LogManager.getLogger(OmarMod.class);
	public static final String MODID = "omar";
