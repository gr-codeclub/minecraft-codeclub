...
@Mod("kristan")
public class KristanMod {
	public static final Logger LOGGER = LogManager.getLogger(KristanMod.class);
	public static final String MODID = "kristan";
