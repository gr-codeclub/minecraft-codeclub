...
@Mod("leanamae")
public class LeanamaeMod {
	public static final Logger LOGGER = LogManager.getLogger(LeanamaeMod.class);
	public static final String MODID = "leanamae";
