 ...
 *
 */
package net.mcreator.fortnitebattlebass;
...
@Mod("fortnite_battle_bass")
public class FortniteBattleBassMod {
	public static final Logger LOGGER = LogManager.getLogger(FortniteBattleBassMod.class);
	public static final String MODID = "fortnite_battle_bass";

	public FortniteBattleBassMod() {
