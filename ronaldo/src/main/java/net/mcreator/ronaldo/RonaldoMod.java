...
@Mod("ronaldo")
public class RonaldoMod {
	public static final Logger LOGGER = LogManager.getLogger(RonaldoMod.class);
	public static final String MODID = "ronaldo";
