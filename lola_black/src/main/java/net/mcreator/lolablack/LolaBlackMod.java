 ...
 *
 */
package net.mcreator.lolablack;
...
@Mod("lola_black")
public class LolaBlackMod {
	public static final Logger LOGGER = LogManager.getLogger(LolaBlackMod.class);
	public static final String MODID = "lola_black";

	public LolaBlackMod() {
		MinecraftForge.EVENT_BUS.register(this);
		LolaBlackModTabs.load();
