...
package net.mcreator.lolablack.world.biome;
...
public class LolaBiomeBiome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-16777216).waterColor(-16724788).waterFogColor(-16777216).skyColor(-16777216).foliageColorOverride(-16724788).grassColorOverride(-16777216).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("lola_black:tree_lola_biome",
						FeatureUtils.register("lola_black:tree_lola_biome", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("lola_black:grass_lola_biome", VegetationFeatures.PATCH_GRASS, List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("lola_black:flower_lola_biome", VegetationFeatures.FLOWER_DEFAULT,
		...
		mobSpawnInfo.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(LolaBlackModEntities.SPIDERFJF.get(), 20, 30, 40));
