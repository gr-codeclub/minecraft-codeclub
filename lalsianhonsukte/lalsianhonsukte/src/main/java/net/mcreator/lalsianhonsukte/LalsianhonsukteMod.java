 ...
 *
 */
package net.mcreator.lalsianhonsukte;
...
@Mod("lalsianhonsukte")
public class LalsianhonsukteMod {
	public static final Logger LOGGER = LogManager.getLogger(LalsianhonsukteMod.class);
	public static final String MODID = "lalsianhonsukte";

	public LalsianhonsukteMod() {
