 ...
 *
 */
package net.mcreator.lorikberisha;
...
@Mod("lorikberisha")
public class LorikberishaMod {
	public static final Logger LOGGER = LogManager.getLogger(LorikberishaMod.class);
	public static final String MODID = "lorikberisha";

	public LorikberishaMod() {
