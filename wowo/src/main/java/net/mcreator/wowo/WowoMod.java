...
@Mod("wowo")
public class WowoMod {
	public static final Logger LOGGER = LogManager.getLogger(WowoMod.class);
	public static final String MODID = "wowo";
