 ...
 *
 */
package net.mcreator.josephine;
...
@Mod("josephine")
public class JosephineMod {
	public static final Logger LOGGER = LogManager.getLogger(JosephineMod.class);
	public static final String MODID = "josephine";
